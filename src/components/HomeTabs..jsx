                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
                        <Nav className="align-items-center">
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href={`/${rut}/solicitudes`} >Solicitar</Dropdown.Item>
                                    <Dropdown.Item href={`/${rut}/missolicitudes`}>Mis solicitudes</Dropdown.Item>
                                    <Dropdown.Item href="/decretos">Generación de Decretos</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>

                            {/* Botones restantes */}
                            <Button href={`/${rut}`} variant="light" className="me-2 rounded-pill border-0 text-dark home-tab-button">
                            ...
                            {/* Otros botones */}
                            <Button href={`/${rut}/ausencias`}  variant="light" className="me-2 rounded-pill border-0 text-dark home-tab-button">
                            ...
                            <Button href={`/${rut}/feriados`}  variant="light" className="me-2 rounded-pill border-0 text-dark home-tab-button">
                            ...
                            <Button href={`/${rut}/licencias`} variant="light" className="me-2 rounded-pill border-0 text-dark home-tab-button">
                            ...
                            {isJefe && (
                                <div className='text-center text-white mt-3'>
                                    <a href={`/${rut}/inboxSol`} style={{ textDecoration: 'none', color: 'black' }}>
